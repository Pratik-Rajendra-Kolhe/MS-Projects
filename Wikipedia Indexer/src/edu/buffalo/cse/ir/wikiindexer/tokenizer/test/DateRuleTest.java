		...
		if (rule == null) {
			...
			try {
				if (isPreTokenization) {
					assertArrayEquals(
							new Object[] { "Vidya Balan born 19780118 is an Indian actress." },
							runtest("Vidya Balan born 18 January 1978 is an Indian actress."));
					assertArrayEquals(
					...
					assertArrayEquals(
							new Object[] { "Godse approached Gandhi on 20090903 during 20090903 the evening prayer at 17:15:00." },
							runtest("Godse approached Gandhi on Sept 03, 2009 during Sept 03 2009 the evening prayer at 5:15PM."));
					assertArrayEquals(
					...
					assertArrayEquals(
							new Object[] { "Apple is one of the world's most valuable publicly traded companies in 20110101�20120101." },
							runtest("Apple is one of the world's most valuable publicly traded companies in 2011�12."));
				} else {
					assertArrayEquals(
